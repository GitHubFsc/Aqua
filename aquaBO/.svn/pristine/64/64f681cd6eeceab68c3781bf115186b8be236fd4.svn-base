var create_folder = (function($, Dialog, Combo){
  var Pane = {
    ...
    initWidgets(){
      this.widgets.is_manul = new Combo('#navigation_create_is_manul', [{key: i18n('NAVIGATE_CREATE_FOLDER_ISMANUAL_MANUAL'),value: true},{key: i18n('NAVIGATE_CREATE_FOLDER_ISMANUAL_AUTO'),value: false}], {
