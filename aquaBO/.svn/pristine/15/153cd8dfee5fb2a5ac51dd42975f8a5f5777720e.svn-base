var DetailDialog = (function ($, Dialog) {
  ...
  let Pane = {
    ...
    loadData() {
      ...
      $("._dialog_body input#order_id").val(Data.order_id);
      ...
      $("._dialog_body input#event_time").val(API.convertTimeString(Data.event_time));
      $("._dialog_body input#delete_type").val(Data.delete_type);
    }
  };
  let API = {
