    ...
    analysis.channelHistory = {
        ...
        setTimePickerWidgets: function() {
            ...
            var datePickerStart = new DatePicker({
                containerId: 'au_time_picker_date_picker_start',
            ...
            var datePickerEnd = new DatePicker({
                containerId: 'au_time_picker_date_picker_end',
                calendarStyles: calendarStyles,
                dateInputStyles: dateInputStyles,
                editable: false
            });
            ...
            shortcutEnable = jQuery('#au_time_picker_shortcut_enable');
            shortcutInput = jQuery('#au_time_picker_shortcut_input');
