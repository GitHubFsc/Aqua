 ...
 * 节目更新管理
 */
navigate.toAssetUpdateManage = function(callback){
	var jses = [
    {"name":"../../../uiWidget/datePicker.js","removable":true},
    {"name":"../../../uiWidget/styledList.js","removable":true},
    {"name":"index.js","removable":true}
	];
  includePage('page_container', 'content/asset/program_update', 'index.html', jses, callback);
}

navigate.toAbnormalOrder = function(callback){
	var jses = [
    {name: '../../../uiWidget/styledList.js', removable: true},
    {name: '../../../uiWidget/alert_dialog.js', removable: true},
    {name: "index.js", removable: true}
  ];
	includePage('page_container', 'content/authmng/abnormalOrders', 'index.html', jses, callback);
}

navigate.toAssetExportAll = function(callback){
	var jses = [
    {name:"index.js","removable":true}
	];
	includePage('page_container', 'content/asset/asset_export_all', 'index.html', jses, callback);
}

navigate.toChannelManagement = function(callback){
	// var jses = [
 //    {"name":"../../../uiWidget/alert_dialog.js","removable":true},
 //    {"name":"../../../uiWidget/newSelect.js","removable":true},
 //    {"name":"../../../uiWidget/styledList.js","removable":true},
 //    {name: "info.js", removable: true},
 //    {name: "index.js", removable: true}
 //  ];
 //  includePage('page_container', 'content/channel/manage', 'index.html', jses, callback);
}

navigate.toChannelMetaManage = function(callback){
	var jses = [
    {"name":"../../../uiWidget/alert_dialog.js","removable":true},
    {"name":"../../../uiWidget/newCalendar.js","removable":true},
    {"name":"../../../uiWidget/datePicker.js","removable":true},
  ...
  includePage('page_container', 'content/channel/meta', 'index.html', jses, callback);
}
