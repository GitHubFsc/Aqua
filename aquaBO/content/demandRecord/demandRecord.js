 ...
 * 单人查询
 */
demandRrecord.toSingleQuery = function (obj) {
  ...
  //includePage("page_container","content/brodecastRecord/brodecaSingleSearch","popupDiv-newSearch.html",jses);
};

/**
 * 批量查询-详单
 */
demandRrecord.toBatchQuery = function (obj) {
  this.changeMenuStyle(obj);
  var jses = [{
    "name": "../../../js/jquery.mCustomScrollbar.concat.min.js",
    "removable": true
  ...
  includePage("page_container", "content/brodecastRecord/BatchQuery", "BatchQuery.html", jses);
  console.log("detail");
};
/**
 * 批量查询-统计
 */
demandRrecord.toBatchQueryStatistics = function (obj) {
  this.changeMenuStyle(obj);
  var jses = [{
    "name": "../../../js/jquery.mCustomScrollbar.concat.min.js",
    "removable": true
  ...
  includePage("page_container", "content/brodecastRecord/BatchQuery", "BatchQuery_statistics.html", jses);
 ...
 * 批量导出
 */
demandRrecord.toBatchExport = function (obj) {
  this.changeMenuStyle(obj);
  var jses = [{
    ...
    "name": "../BatchQuery/queryWin.js",
    "removable": true
  }, {
    "name": "BatchExport.js",
    "removable": true
  }];
  includePage("page_container", "content/brodecastRecord/BatchExport", "BatchExport.html", jses);
};

/**
 * 基本设置
 */
demandRrecord.toBasicSettings = function (obj) {
  this.changeMenuStyle(obj);
  var jses = [];
  var jses = [{
    "name": "../../../js/jquery.mCustomScrollbar.concat.min.js",
  ...
  includePage("page_container", "content/brodecastRecord/BasicSetting", "BasicSettings.html", jses);
};
