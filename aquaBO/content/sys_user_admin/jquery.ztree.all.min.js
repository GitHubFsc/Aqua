...
(function(q) {
    ...
    i = {
        ...
        makeDOMNodeLine: function(a, b, c) {
            ...
            a.push("<div style=\"position:absolute;width:100%;height:13px;background-color:white\"></div><img style=\"position:absolute;;display:"+display_+";top:20px;left:-20px\" src=\"content/sys_user_admin/images/line.png\"/><span id='", c.tId, f.id.SWITCH, "' title='' class='", i.makeNodeLineClass(b, c), "' treeNode", f.id.SWITCH, "></span>")
				},
