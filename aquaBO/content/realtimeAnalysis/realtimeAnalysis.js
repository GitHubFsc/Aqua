...
(function(JS) {
    ...
    realtimeAnalysis.changeTitleTxt = function(obj) {
        var titleTxt = this.titleTxts[jQuery(obj).attr('id')];
        if (titleTxt) {
            jQuery('#au_analysis_titletxt').attr('src', titleTxt);
        }
    };
    ...
    realtimeAnalysis.updateClock = function() {
        this.clockTime += 1000;
        var clock;
        if ( clock = document.getElementById('au_analysis_clock')) {
            clock.innerHTML = this.getTimeStr(this.clockTime);
    ...
    realtimeAnalysis.analyzeChannelRealtime = function(obj) {
        this.changeMenuStyle(obj);
        this.changeTitleTxt(obj);
        ...
        uiUtil.includePage('au_analysis_content', 'content/realtimeAnalysis/channelRealtime', 'channel_realtime.html', jses);
    };

    realtimeAnalysis.analyzeChannelHistory = function(obj) {
        this.changeMenuStyle(obj);
        this.changeTitleTxt(obj);
        var jses = window.JS.loadDependence([{
            module: 'StyledSwitcher',
        ...
        uiUtil.includePage('au_analysis_content', 'content/realtimeAnalysis/channelHistory', 'channel_history.html', jses);
    };

    realtimeAnalysis.analyzeProgramHistory = function(obj) {
        this.changeMenuStyle(obj);
        this.changeTitleTxt(obj);
        var jses = window.JS.loadDependence([{
            module: 'StyledSwitcher',
        ...
        uiUtil.includePage('au_analysis_content', 'content/realtimeAnalysis/programHistory', 'program_history.html', jses);
    };
    // @formatter:off
}(window.JS));
// @formatter:on
