...
batchQuery.refreshRequestOnMainPanel = function () {
	...
	jQuery("[name=requestPanel]").append("<div alt=\"edit\" class=\"pageTitleContainerRightButt\" style=\"width:70px;height:30px;line-height:30px;margin:3px;font-size:14px;\" onclick=\"batchQuery.openQueryWin(this)\">编&nbsp;辑</div>"); //editBtn
};
