...
NewStyledList.prototype.init = function(){
	this.footLabels = {
...
NewStyledList.prototype.create = function(){
	this.createList();
	var self = this;
...
NewStyledList.prototype.getPageData = function(pageNumber, callback){

};

NewStyledList.prototype.onTotalCount = function(count){
    this.totalCount = Number(count);
    this.pagesLmt = Math.ceil(this.totalCount/this.rowsLmt);
};

NewStyledList.prototype.update = function(param){
	if(this.listType === 0){
		this.data = param;
		this.totalCount = this.data && this.data.length  || 0;
		this.pagesLmt = Math.ceil(this.totalCount/this.rowsLmt);
...
NewStyledList.prototype.fillContent = function(callback){
...
NewStyledList.prototype.createList = function(){
...
NewStyledList.prototype.fillList = function(){
	this.fillListHead();
	this.fillListBody();
	this.fillListFoot();
};

NewStyledList.prototype.addListHead = function(jqTable){
...
NewStyledList.prototype.fillListHead = function(){
	var self = this;
...
NewStyledList.prototype.addListBody = function(jqTable){
...
NewStyledList.prototype.fillListBody = function(){
	var self = this;
...
NewStyledList.prototype.addListFoot = function(jqTable){
	...
	var innerTable = '<table cellspacing="7" class=\"tFoot_table\"><tbody><tr><td styledlistfunc="beginPage" class="tFootEle_basic tFootEle_border_font" style="width:43px">'+i18n('UIWIDGET_STYLEDLIST_SHOUYE')+'</td>';
	innerTable=innerTable	+ '<td styledlistfunc="prevPage" class="tFootEle_basic tFootEle_border_font" style="width:55pxs">'
		+ this.getPrevIcon()
		+ '</td><td style="width:26px;background-color:#fe931f;color:#ffffff" styledlistfunc="curPage">'
		+ '</td><td styledlistfunc="nextPage" class="tFootEle_basic tFootEle_border_font" style="width:55px">'
		+ this.getNextIcon()
		+ '</td><td styledlistfunc="endPage" class="tFootEle_basic tFootEle_border_font" style="width:42px">'+i18n('UIWIDGET_STYLEDLIST_WEIYE')+'</td>'
		+ '<td class="tFootEle_basic" style="width:20px;color:#777777">'
...
NewStyledList.prototype.fillListFoot = function(){
	var self = this;
...
NewStyledList.prototype.getPrevIcon = function(){
	var prevPageIcon=i18n('UIWIDGET_STYLEDLIST_SHANGYIYE');
	return prevPageIcon;
};

NewStyledList.prototype.getNextIcon = function(){
	var nextPageIcon=i18n('UIWIDGET_STYLEDLIST_XIAYIYE');
	return nextPageIcon;
};

NewStyledList.prototype.setStyles = function(jqTable){
...
NewStyledList.prototype.changePage = function(changeType){
...
NewStyledList.prototype.refreshList = function(){
	var self = this;
	this.fillContent(function(){
		if(self.updateTitle){
			self.fillListHead();
...
NewStyledList.prototype.updateInPage = function(data){
...
NewStyledList.prototype.resize = function(){
    this.createList();
    this.fillList();
};
