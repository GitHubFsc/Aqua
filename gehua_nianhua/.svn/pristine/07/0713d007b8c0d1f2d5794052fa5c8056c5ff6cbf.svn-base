var MyStorage = (function(){
	...
	function Storage(option){
		...
		if(typeof iPanel != 'undefined' && typeof iPanel.getGlobalVar == 'function' && typeof iPanel.setGlobalVar == 'function'){
			this.setter = function(name, value){
			...
			this.type = 'iPanel';
		} else if(typeof CyberCloud != 'undefined' || typeof DataAccess != 'undefined'){
			this.setter = function(name, value){
				cookie.setCookieItem(name, value);
			}
			this.getter = function(name){
