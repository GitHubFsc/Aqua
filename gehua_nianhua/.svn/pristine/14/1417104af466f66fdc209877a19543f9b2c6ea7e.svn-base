...
var Youai = {
	init: function(){
		...
		this.columnNode = new ColumnNode(RootNode, '有哎', '0');
...
UiCatCast.down = function(){
	...
	} else if(this.grid != null && this.grid.down()){
		this.changeGridFocus();
	}
};
UiCatCast.left = function(){
	if(this.isOverlay){
		if(this.overGrid != null && this.overGrid.left()){
			this.changeOverGridFocus();
		}
	} else if(this.grid != null && this.grid.left()){
		this.changeGridFocus();
	}
};
UiCatCast.right = function(){
	if(this.isOverlay){
		if(this.overGrid != null && this.overGrid.right()){
			this.changeOverGridFocus();
		}
	} else if(this.grid != null && this.grid.right()){
		this.changeGridFocus();
	}
};
