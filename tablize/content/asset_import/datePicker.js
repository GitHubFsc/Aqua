function AssetImportDatePicker(obj){
	var confObj = obj;
	if(confObj){
...
AssetImportDatePicker.prototype.init = function(){
...
AssetImportDatePicker.prototype.createPickerComponents = function(){
...
AssetImportDatePicker.prototype.openCalendar = function(){
	this.calendar.open();
};

AssetImportDatePicker.prototype.closeCalendar = function(){
	this.calendar.close();
};

AssetImportDatePicker.prototype.toggleCalendar = function(){
	this.calendar.toggle();
};

AssetImportDatePicker.prototype.setCalendarDate = function(){
	var dateStr = this.jqDateInput.val();
	this.calendar.setCurrDate(this.parseDateStr(dateStr));
	this.setInputDate();
};

AssetImportDatePicker.prototype.onChange = function(){

};

AssetImportDatePicker.prototype.setInputDate = function(){
...
AssetImportDatePicker.prototype.formDateStr = function(year, month, date){
	return year
		+ '-'
...
AssetImportDatePicker.prototype.parseDateStr = function(dateStr){
...
AssetImportDatePicker.prototype.getDate = function(){
	return this.inputDate;
};

AssetImportDatePicker.prototype.getMonth = function(){
	return this.inputMonth;
};

AssetImportDatePicker.prototype.getYear = function(){
	return this.inputYear;
};

AssetImportDatePicker.prototype.getDateStr = function(){
	return this.inputDateStr;
};

AssetImportDatePicker.prototype.setCurrDate = function(dest){
	if(dest){
...
AssetImportDatePicker.prototype.disable = function(){
    this.jqDateInput.attr('disabled', true);
    this.$datePickerIcon.unbind();
};

AssetImportDatePicker.prototype.enable = function(){
    var self = this;
...
AssetImportDatePicker.prototype.handleDropdowns = function(target, delegate){
    var container = document.getElementById(this.containerId);
...
AssetImportDatePicker.prototype.clear = function(){
