function navigationSlider_DatePicker(obj){
	var confObj = obj;
	if(confObj){
...
navigationSlider_DatePicker.prototype.init = function(){
...
navigationSlider_DatePicker.prototype.createPickerComponents = function(){
  ...
  add_HourMinuteSecondInput.call(self);
  ...
  function add_dialog_BG(){
    ...
    var hourSelect = new TicketnewSelect('#' + this.hourSelectId, [], {
      width: 110,
      height: 30,
      background: "white",
      fontSize: 14,
    ...
    var minuteSelect = new TicketnewSelect('#' + this.minuteSelectId, [], {
      width: 110,
      height: 30,
      background: "white",
      fontSize: 14,
...
navigationSlider_DatePicker.prototype.openCalendar = function(){
	this.calendar.open();
};

navigationSlider_DatePicker.prototype.closeCalendar = function(){
	this.calendar.close();
};

navigationSlider_DatePicker.prototype.toggleCalendar = function(){
	this.calendar.toggle();
};

navigationSlider_DatePicker.prototype.openDialog = function(){
  this.$dialogBg.show();
};

navigationSlider_DatePicker.prototype.closeDialog = function(){
  this.$dialogBg.hide();
};

navigationSlider_DatePicker.prototype.toggleDialog = function(){
  this.$dialogBg.toggle();
};

navigationSlider_DatePicker.prototype.setCalendarDate = function(){
...
navigationSlider_DatePicker.prototype.onEnterKeyDownEvent = function(){
};

navigationSlider_DatePicker.prototype.onChange = function(){

};

navigationSlider_DatePicker.prototype.setInputDate = function(){
...
navigationSlider_DatePicker.prototype.formDateStr = function(year, month, date){
	return year
		+ '-'
...
navigationSlider_DatePicker.prototype.parseDateStr = function(dateStr){
...
navigationSlider_DatePicker.prototype.getDate = function(){
	return this.inputDate;
};

navigationSlider_DatePicker.prototype.getMonth = function(){
	return this.inputMonth;
};

navigationSlider_DatePicker.prototype.getYear = function(){
	return this.inputYear;
};

navigationSlider_DatePicker.prototype.getHour = function(){
  return this.inputHour;
};

navigationSlider_DatePicker.prototype.getMinute = function(){
  return this.inputMinute;
};

navigationSlider_DatePicker.prototype.getISOString = function(){
...
navigationSlider_DatePicker.prototype.getDateStr = function(){
	return this.inputDateStr;
};

navigationSlider_DatePicker.prototype.setCurrDate = function(dest){
	if(dest){
...
navigationSlider_DatePicker.prototype.disable = function(){
    this.jqDateInput.attr('disabled', true);
    this.$datePickerIcon.unbind();
};

navigationSlider_DatePicker.prototype.enable = function(){
    var self = this;
...
navigationSlider_DatePicker.prototype.handleDropdowns = function(target, delegate){
    var container = document.getElementById(this.containerId);
...
navigationSlider_DatePicker.prototype.clear = function(){
