...
function AppAdmin_StyledList(obj){
	var conf = obj;
	if(conf){
		...
		this.currentPage=conf.currentPage || false;
	}
	if(!this.containerId)
		return null;
	else
...
AppAdmin_StyledList.prototype.init = function(){
	this.footLabels = {
		navPre: '转到第',
		navSuf: '页，',
		curPre: '当前第',
	...
	if(this.currentPage){this.currPage = this.currentPage}
...
AppAdmin_StyledList.prototype.create = function(){
	this.createList();
	var self = this;
...
AppAdmin_StyledList.prototype.getPageData = function(pageNumber, callback){

};

AppAdmin_StyledList.prototype.onTotalCount = function(count){
    this.totalCount = Number(count);
    this.pagesLmt = Math.ceil(this.totalCount/this.rowsLmt);
};

AppAdmin_StyledList.prototype.update = function(param){
	if(this.listType === 0){
		this.data = param;
		this.totalCount = this.data && this.data.length  || 0;
		this.pagesLmt = Math.ceil(this.totalCount/this.rowsLmt);
...
AppAdmin_StyledList.prototype.fillContent = function(callback){
...
AppAdmin_StyledList.prototype.createList = function(){
...
AppAdmin_StyledList.prototype.fillList = function(){
	this.fillListHead();
	this.fillListBody();
	this.fillListFoot();
};

AppAdmin_StyledList.prototype.addListHead = function(jqTable){
...
AppAdmin_StyledList.prototype.fillListHead = function(){
	var self = this;
...
AppAdmin_StyledList.prototype.addListBody = function(jqTable){
...
AppAdmin_StyledList.prototype.fillListBody = function(){
	var self = this;
...
AppAdmin_StyledList.prototype.addListFoot = function(jqTable){
...
AppAdmin_StyledList.prototype.fillListFoot = function(){
	var self = this;
...
AppAdmin_StyledList.prototype.getPrevIcon = function(){
...
AppAdmin_StyledList.prototype.getNextIcon = function(){
	var iconColor = this.styles && this.styles.iconColor || 'black';
...
AppAdmin_StyledList.prototype.setStyles = function(jqTable){
...
AppAdmin_StyledList.prototype.changePage = function(changeType){
...
AppAdmin_StyledList.prototype.refreshList = function(){
	var self = this;
	this.fillContent(function(){
		if(self.updateTitle){
			self.fillListHead();
...
AppAdmin_StyledList.prototype.updateInPage = function(data){
	//Same length of Data
	if(this.listType === 0){
		this.data = data;
		this.fillContent();
...
AppAdmin_StyledList.prototype.resize = function(){
    this.createList();
    this.fillList();
};
