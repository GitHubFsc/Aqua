...
function SetTagByTagStyledList(obj){
  this.everyPageDatas={};
	var conf = obj;
	if(conf){
...
SetTagByTagStyledList.prototype.init = function(){
	this.footLabels = {
		navPre: '转到第',
		navSuf: '页，',
		curPre: '当前第',
...
SetTagByTagStyledList.prototype.create = function(){
	this.createList();
	var self = this;
...
SetTagByTagStyledList.prototype.getPageData = function(pageNumber, callback){

};

SetTagByTagStyledList.prototype.onTotalCount = function(count){
    this.totalCount = Number(count);
    this.pagesLmt = Math.ceil((this.totalCount)/this.itemsCountOneRow/this.rowsLmt);
};

SetTagByTagStyledList.prototype.update = function(param){
	if(this.listType === 0){
		this.data = param;
		this.totalCount = this.data && this.data.length  || 0;
		this.pagesLmt = Math.ceil(this.totalCount/this.rowsLmt);
...
SetTagByTagStyledList.prototype.fillContent = function(callback){
...
SetTagByTagStyledList.prototype.createList = function(){
...
SetTagByTagStyledList.prototype.fillList = function(){
	this.fillListHead();
	this.fillListBody();
	this.fillListFoot();
};

SetTagByTagStyledList.prototype.addListHead = function(jqTable){
...
SetTagByTagStyledList.prototype.fillListHead = function(){
	var self = this;
...
SetTagByTagStyledList.prototype.addListBody = function(jqTable){
...
SetTagByTagStyledList.prototype.fillListBody = function(){
	var jq=jQuery;
	var self = this;
...
SetTagByTagStyledList.prototype.addListFoot = function(jqTable){
...
SetTagByTagStyledList.prototype.fillListFoot = function(){
	var self = this;
...
SetTagByTagStyledList.prototype.getPrevIcon = function(){
...
SetTagByTagStyledList.prototype.getNextIcon = function(){
	var iconColor = this.styles && this.styles.iconColor || 'black';
...
SetTagByTagStyledList.prototype.setStyles = function(jqTable){
...
SetTagByTagStyledList.prototype.changePage = function(changeType){
  var that=this;
	var checkedArray=[];
...
SetTagByTagStyledList.prototype.refreshList = function(){
	var self = this;
	this.fillContent(function(){
		if(self.updateTitle){
			self.fillListHead();
...
SetTagByTagStyledList.prototype.updateInPage = function(data){
	//Same length of Data
	if(this.listType === 0){
		this.data = data;
		this.fillContent();
...
SetTagByTagStyledList.prototype.resize = function(){
    this.createList();
    this.fillList();
};
