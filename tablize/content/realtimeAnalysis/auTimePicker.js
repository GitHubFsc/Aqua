    ...
    AuTimePicker.prototype = {
        ...
        getPicker: function() {
            ...
            var self = this,
                ...
                calendarCont = '<div id="programHistory_au_time_picker_calendar"></div>',
                timesCont = jQuery(document.createElement('div')),
                timesContent = '<p class="au_time_picker_label" style="top:5px;">开始时间点：</p>' +
					'<div id="programHistory_au_time_picker_start_hour"></div>' + '<p class="au_time_picker_split_front" style="top:24px;left:65px;">点：</p>' +
					'<div id="programHistory_au_time_picker_start_min"></div>' + '<p class="au_time_picker_split_back" style="top:24px;left:165px;">分</p>' +
					'<p class="au_time_picker_label" style="top:75px;">结束时间点：</p>' +
					'<div id="programHistory_au_time_picker_end_hour"></div>' + '<p class="au_time_picker_split_front" style="top:95px;left:65px;">点：</p>' +
					'<div id="programHistory_au_time_picker_end_min"></div>' + '<p class="au_time_picker_split_back" style="top:95px;left:165px;">分</p>',
				channelsContent = '<p class="au_time_picker_label" style="top:5px;">频道名称：</p>' + 
		            '<div id="programHistory_au_time_picker_channels_dropdown"></div>' +
		            '<p class="au_time_picker_label" style="top:60px;">栏目开始时间：</p>' +
                    '<div id="programHistory_au_time_picker_start_hour"></div>' + '<p class="au_time_picker_split_front" style="top:79px;left:65px;">点：</p>' +
                    '<div id="programHistory_au_time_picker_start_min"></div>' + '<p class="au_time_picker_split_back" style="top:79px;left:165px;">分</p>' +
                    '<p class="au_time_picker_label" style="top:130px;">栏目结束时间：</p>' +
                    '<div id="programHistory_au_time_picker_end_hour"></div>' + '<p class="au_time_picker_split_front" style="top:150px;left:65px;">点：</p>' +
                    '<div id="programHistory_au_time_picker_end_min"></div>' + '<p class="au_time_picker_split_back" style="top:150px;left:165px;">分</p>';		
        ...
        getDualPicker: function() {
            ...
            var self = this,
                ...
                timesContent = '<p class="au_time_picker_label" style="top:5px;left:15px;">开始日期：</p>' +
                    '<div id="channel_history_au_time_picker_date_picker_start"></div>' +
                    '<p class="au_time_picker_label" style="top:65px;left:15px;">结束日期：</p>' +
                    '<div id="channel_history_au_time_picker_date_picker_end"></div>' +
                    '<p class="au_time_picker_label" style="top:130px;left:15px;">开始时间点：</p>' +
                    '<div id="channel_history_au_time_picker_start_hour"></div>' + '<p class="au_time_picker_split_front" style="top:150px;left:80px;">点：</p>' +
                    '<div id="channel_history_au_time_picker_start_min"></div>' + '<p class="au_time_picker_split_back" style="top:150px;left:180px;">分</p>' +
                    '<p class="au_time_picker_label" style="top:200px;left:15px;">结束时间点：</p>' +
                    '<div id="channel_history_au_time_picker_end_hour"></div>' + '<p class="au_time_picker_split_front" style="top:220px;left:80px;">点：</p>' +
                    '<div id="channel_history_au_time_picker_end_min"></div>' + '<p class="au_time_picker_split_back" style="top:220px;left:180px;">分</p>' +
                    '<div id="channel_history_au_time_picker_shortcut">' + 
                    '<input type="checkbox" id="channel_history_au_time_picker_shortcut_enable"/>过去' + 
                    '<input type="text" id="channel_history_au_time_picker_shortcut_input"/>分钟' +
                    '</div>';
