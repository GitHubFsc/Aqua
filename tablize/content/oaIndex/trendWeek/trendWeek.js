var OATrendWeek = (function($){
  ...
  var iTrend = {
    init: function(){
      var self = this;
      this.userChart = echarts.init(document.getElementById('oaTrendWeek-sum-pcount-chart'));
      // this.actionChart = echarts.init(document.getElementById('oaTrendWeek-sum-tcount-chart'));
      this.scaleSelect = getSelector('oaTrendWeek-sum-scale-select',[{
      ...
      this.startPicker = new DatePicker({
        containerId: 'oa-oaTrendWeek-start-datepicker',
      ...
      this.endPicker = new DatePicker({
        containerId: 'oa-oaTrendWeek-end-datepicker',
        calendarStyles: calendarStyles,
        dateInputStyles: dateInputStyles,
        iconImage: 'images/operateanalyze/oa-dp-cal-icon.png',
        iconStyle: {
    ...
    setUserChecker: function(){
      ...
      $('#oaTrendWeek-sum-pcount-indexes').on('click', function() {
    ...
    drawUserList: function(keys, data){
      ...
      $('#oaTrendWeek-sum-pcount-list').mCustomScrollbar('destroy').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
    ...
    getUserTrendData: function(keys, callback){
      ...
      // for(var i = 0; i < 22; i+=1){
        ...
        // data.push(item);
      // }
      var url = AquaDaaSHost + '/aquadaas/rest/analytics/week';
    ...
    setActionChecker: function(){
      ...
      $('#oaTrendWeek-sum-tcount-indexes').on('click', function(){
    ...
    drawActionList: function(keys, data){
      ...
      $('#oaTrendWeek-sum-tcount-list').mCustomScrollbar('destroy').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
