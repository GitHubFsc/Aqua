var OATrendMonth = (function($){
  ...
  var monthLabels = [null, i18n('OA_TREND_MONTH_1'), i18n('OA_TREND_MONTH_2'), i18n('OA_TREND_MONTH_3'), i18n('OA_TREND_MONTH_4'),
    i18n('OA_TREND_MONTH_5'), i18n('OA_TREND_MONTH_6'), i18n('OA_TREND_MONTH_7'), i18n('OA_TREND_MONTH_8'),
    i18n('OA_TREND_MONTH_9'), i18n('OA_TREND_MONTH_10'), i18n('OA_TREND_MONTH_11'), i18n('OA_TREND_MONTH_12')];
  ...
  var iTrend = {
    init: function(){
      var self = this;
      this.userChart = echarts.init(document.getElementById('oaTrendMonth-sum-pcount-chart'));
      // this.actionChart = echarts.init(document.getElementById('oaTrendMonth-sum-tcount-chart'));
      this.scaleSelect = getSelector('oaTrendMonth-sum-scale-select',[{
      ...
      this.startPicker = new DatePicker({
        containerId: 'oa-oaTrendMonth-start-datepicker',
      ...
      this.endPicker = new DatePicker({
        containerId: 'oa-oaTrendMonth-end-datepicker',
        calendarStyles: calendarStyles,
        dateInputStyles: dateInputStyles,
        iconImage: 'images/operateanalyze/oa-dp-cal-icon.png',
        iconStyle: {
    ...
    setUserChecker: function(){
      ...
      $('#oaTrendMonth-sum-pcount-indexes').on('click', function() {
    ...
    drawUserChart: function(keys, data){
      ...
      var sampleTimes = sample.map(function(item){
        ...
        var label = monthLabels[Number(mstr)];
        return label;
      });
    ...
    drawUserList: function(keys, data){
      ...
      for(var i = 0, len = sample.length; i < len; i += 1){
        ...
        var timeLabel = monthLabels[Number(timem)];
        $('<td>').append(
      ...
      $('#oaTrendMonth-sum-pcount-list').mCustomScrollbar('destroy').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
    ...
    getUserTrendData: function(keys, callback){
      ...
      // for(var i = 0; i < 22; i+=1){
        ...
        // data.push(item);
      // }
      var url = AquaDaaSHost + '/aquadaas/rest/analytics/month';
    ...
    setActionChecker: function(){
      ...
      $('#oaTrendMonth-sum-tcount-indexes').on('click', function(){
    ...
    drawActionList: function(keys, data){
      ...
      $('#oaTrendMonth-sum-tcount-list').mCustomScrollbar('destroy').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
