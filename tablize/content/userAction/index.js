var userAction = (function ($) {
  ...
  userAction.initTime = function () {
    ...
    var yTypeSelect = new TicketnewSelect("#userAction_yType", select_options, {
      width: 115,
      height: 32,
      background: "#ffffff",
      fontSize: 12,
  ...
  userAction.bindEvent = function () {
    ...
    $("#userAction_quota_button").unbind("click").click(function () {
      userAction_Lib.openQuotaDialog(that.options.SelectedQuotaArray, function(result){
        ...
        that.updateOptionsCheckbox({
          containerID: "userAction_display_container_zhibiao",
          tag: "quota",
    ...
    $('#userAction_display_container_zhibiao').unbind("click").on('click', '.trendAnalysis_checkbox.quota', function (ev) {
  ...
  userAction.getSelectedQuotaArray = function () {
    ...
    $("#userAction_display_container_zhibiao .trendAnalysis_checkbox>.checkbox>input:checked").each(function (index, el) {
  ...
  userAction.initLineChart = function () {
    ...
    var myChart = echarts.init(document.getElementById('userAction_trendAnalysis_lineChart'));
