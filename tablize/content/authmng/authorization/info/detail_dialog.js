var AuthoInfoDetailDialog = (function ($, Dialog) {
  let Data = {
    device_id: "",
    ticket_id: "",
    asset_id: "",
  ...
  let Pane = {
    init() {
      ...
      loadData() {
        $("._dialog_body input#authoInfo_card_id").val(Data.user_id);
        $("._dialog_body input#authoInfo_ticket_id").val(Data.ticket_id);
        $("._dialog_body input#authoInfo_asset_type").val(Data.asset_type);
        $("._dialog_body input#authoInfo_asset_id").val(Data.asset_id);
        $("._dialog_body input#authoInfo_app_key").val(Data.app_key);
        $("._dialog_body input#authoInfo_product_id").val(Data.product_id);
        $("._dialog_body input#authoInfo_bundle_id").val(Data.bundle_id);
        $("._dialog_body input#authoInfo_home_id").val(Data.home_id);
        $("._dialog_body input#authoInfo_effective_time").val(API.convertTimeString(Data.effective_time));
        $("._dialog_body input#authoInfo_expire_time").val(API.convertTimeString(Data.expire_time));
        $("._dialog_body input#authoInfo_create_time").val(API.convertTimeString(Data.create_time));
        $("._dialog_body input#authoInfo_state").val(i18n("AUTH_MNG_DIALOG_DETAIL_STATE_"+Data.state.toUpperCase()));
      }
  };
  let API = {
