...
(function () {
  ...
  function TicketnewSelect(cantainID, obj, style, listenLiClick, isOther) {
    /*
     style{
     width,
     height,
  ...
  TicketnewSelect.prototype.init = function () {
    this.createSelect();
    this.setStyle();
    this.listenClick();
  ...
  TicketnewSelect.prototype.handleDropdowns = function(target, delegate){
  ...
  TicketnewSelect.prototype.createSelect = function () {
  ...
  TicketnewSelect.prototype.setStyle = function () {
    var that = this;
    this.box.css({
      "position": "relative",
      "box-sizing": "border-box"
  ...
  TicketnewSelect.prototype.listenClick = function () {
    var that = this;
  ...
  TicketnewSelect.prototype.getValue = function () {
    return this.header.attr('data-key');
  }
  TicketnewSelect.prototype.getKey = function () {
    return this.headerContent[0].innerHTML;
  }
  TicketnewSelect.prototype.setValue = function (value) {
    var that = this;
  ...
  TicketnewSelect.prototype.setKey = function (key) {
    var that = this;
    var data = this.selectItem;
    var i;
    var boolean_found = false;
  ...
  TicketnewSelect.prototype.setDisable = function () {
  ...
  TicketnewSelect.prototype.setAvailable = function () {
    this.booleanAvailable = true;
    this.header.css({"background-color": this.selectstyle.background});
  }
  TicketnewSelect.prototype.updateSelectOptions = function (obj) {
    this.destory();
    this.selectItem = obj;
    this.init();
  }
  TicketnewSelect.prototype.switchToOpenIcon = function () {
    this.headerOpenIcon.css({"display": "block"});
    this.headerCloseIcon.hide();
    this.content.hide();
  }
  TicketnewSelect.prototype.switchToCloseIcon = function () {
    this.headerOpenIcon.hide();
    this.headerCloseIcon.css({"display": "block"});
    this.content.show();
  }
  TicketnewSelect.prototype.destory = function (obj) {
  ...
  window.TicketnewSelect = TicketnewSelect;
})();
