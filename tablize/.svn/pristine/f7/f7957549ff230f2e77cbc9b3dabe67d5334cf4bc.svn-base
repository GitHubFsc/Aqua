 ...
 * Calendar构建
 */
function UserAdminCalendar(containerId, custom, year, month){
    this.html = "";
    this.containerId = containerId;
...
UserAdminCalendar.prototype.refresh = function(){
...
UserAdminCalendar.prototype.draw = function(){
    var _html = [];
...
UserAdminCalendar.prototype.monthChange = function(type, dest){
    this.helper.monthChange(type, dest);
    this.refresh();
};

UserAdminCalendar.prototype.onClick = function(object){
    switch(object.id){
        case "back-year":
            this.monthChange(-2);
            break;
 ...
 */
UserAdminCalendar.prototype.extendOnClick = function(object){
};


UserAdminCalendar.prototype.getClickables = function(){
    var clickables = [];
...
UserAdminCalendar.prototype.refreshCurrMonthElements = function(){
    this.curr_month_date_elements = [];
 ...
 */
UserAdminCalendar.prototype.extendRefresh = function(date_list){
};

UserAdminCalendar.prototype.eventHndl = function(){
