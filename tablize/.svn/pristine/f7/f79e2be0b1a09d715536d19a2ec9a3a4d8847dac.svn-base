...
CMSDatePicker.prototype.init = function(){
...
CMSDatePicker.prototype.createPickerComponents = function(){
...
CMSDatePicker.prototype.openCalendar = function(){
	this.calendar.open();
};

CMSDatePicker.prototype.closeCalendar = function(){
	this.calendar.close();
};

CMSDatePicker.prototype.toggleCalendar = function(){
	this.calendar.toggle();
};

CMSDatePicker.prototype.setCalendarDate = function(){
	var dateStr = this.jqDateInput.val();
	this.calendar.setCurrDate(this.parseDateStr(dateStr));
	this.setInputDate();
};

CMSDatePicker.prototype.onChange = function(){

};

CMSDatePicker.prototype.setInputDate = function(){
...
CMSDatePicker.prototype.formDateStr = function(year, month, date){
	return year
		+ '-'
...
CMSDatePicker.prototype.parseDateStr = function(dateStr){
...
CMSDatePicker.prototype.getDate = function(){
	return this.inputDate;
};

CMSDatePicker.prototype.getMonth = function(){
	return this.inputMonth;
};

CMSDatePicker.prototype.getYear = function(){
	return this.inputYear;
};

CMSDatePicker.prototype.getDateStr = function(){
	return this.inputDateStr;
};

CMSDatePicker.prototype.setCurrDate = function(dest){
	if(dest){
...
CMSDatePicker.prototype.disable = function(){
    this.jqDateInput.attr('disabled', true);
    this.$datePickerIcon.unbind();
};

CMSDatePicker.prototype.enable = function(){
    var self = this;
...
CMSDatePicker.prototype.handleDropdowns = function(target, delegate){
    var container = document.getElementById(this.containerId);
...
CMSDatePicker.prototype.clear = function(){
