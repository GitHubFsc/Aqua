 ...
 * Calendar构建
 */
function ProductPkgCalendar(containerId, custom, year, month){
    this.html = "";
    this.containerId = containerId;
...
ProductPkgCalendar.prototype.refresh = function(){
...
ProductPkgCalendar.prototype.draw = function(){
    var _html = [];
...
ProductPkgCalendar.prototype.monthChange = function(type, dest){
    this.helper.monthChange(type, dest);
    this.refresh();
};

ProductPkgCalendar.prototype.onClick = function(object){
    switch(object.id){
        case "back-year":
            this.monthChange(-2);
            break;
 ...
 */
ProductPkgCalendar.prototype.extendOnClick = function(object){
};


ProductPkgCalendar.prototype.getClickables = function(){
    var clickables = [];
...
ProductPkgCalendar.prototype.refreshCurrMonthElements = function(){
    this.curr_month_date_elements = [];
 ...
 */
ProductPkgCalendar.prototype.extendRefresh = function(date_list){
};

ProductPkgCalendar.prototype.eventHndl = function(){
