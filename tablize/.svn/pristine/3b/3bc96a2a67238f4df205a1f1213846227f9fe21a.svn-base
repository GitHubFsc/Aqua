var BatchQueryWin = function (option) {
    var _this = this;
    ...
    _this._win = new PopupDialog({
      ...
      width: 452,
      height: 400,
      callback: BatchQueryWinEventBind,
      context: this,
    ...
    function BatchQueryWinEventBind() {
      //关闭按钮事件
  ...
  BatchQueryWin.prototype.create = function () {
    this._win.create()
  };
  
  BatchQueryWin.prototype.show = function () {
    this._win.show()
  }
