var OATrendDay = (function($){
  ...
  var iTrend = {
    init: function(){
      var self = this;
      this.userChart = echarts.init(document.getElementById('oaTrendDay-sum-pcount-chart'));
      // this.actionChart = echarts.init(document.getElementById('day-sum-tcount-chart'));
      this.scaleSelect = getSelector('oaTrendDay-sum-scale-select',[{
      ...
      this.startPicker = new DatePicker({
        containerId: 'oa-oaTrendDay-start-datepicker',
      ...
      this.endPicker = new DatePicker({
        containerId: 'oa-oaTrendDay-end-datepicker',
        calendarStyles: calendarStyles,
        dateInputStyles: dateInputStyles,
        iconImage: 'images/operateanalyze/oa-dp-cal-icon.png',
        iconStyle: {
    ...
    setUserChecker: function(){
      ...
      $('#oaTrendDay-sum-pcount-indexes').on('click', function() {
    ...
    drawUserList: function(keys, data){
      ...
      $('#oaTrendDay-sum-pcount-list').mCustomScrollbar('destroy').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
    ...
    setActionChecker: function(){
      ...
      $('#oaTrendDay-sum-tcount-indexes').on('click', function(){
    ...
    drawActionList: function(keys, data){
      ...
      $('#oaTrendDay-sum-tcount-list').mCustomScrollbar('destroy').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
