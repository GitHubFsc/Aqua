console.log(1);
function AssetImportStyledSelector(obj){
	if(obj){
		this.containerId = obj.containerId;
		this.selectables = obj.options;
		this.expandCallback= obj.expandCallback;
		this.collapseCallback= obj.collapseCallback;
...
AssetImportStyledSelector.prototype.init = function(){
	this.lvPairs = {};
	this.vlPairs = {};
...
AssetImportStyledSelector.prototype.create = function(){
...
AssetImportStyledSelector.prototype.addSelectorInput = function(jqContainer){
...
AssetImportStyledSelector.prototype.addSelectorIcon = function(jqContainer){
	var cntHeight = jqContainer.height();
	var cntWidth = jqContainer.width();
...
AssetImportStyledSelector.prototype.addSelectorDropBox = function(jqContainer){
	var cntHeight = jqContainer.height();
	var cntWidth = jqContainer.width();
...
AssetImportStyledSelector.prototype.createOptionTable = function(){
	...
	for(var i = 0; i < this.selectables.length; i++){
		...
		jqTd.click(function(){
			...
			label = label.replace(/(&\w+;)/g, function(match, entity){
				return AssetImportStyledSelector.entities[entity];
			});
...
AssetImportStyledSelector.prototype.getOpenIcon = function(){
...
AssetImportStyledSelector.prototype.getCloseIcon = function(){
	var iconColor = this.styles && this.styles.iconColor || 'black';
	var iconInnerColor = this.styles && this.styles.iconInnerColor || 'white';
...
AssetImportStyledSelector.prototype.onChange = function(selector){

};

AssetImportStyledSelector.prototype.getValue = function(){
	return this.value;
};

AssetImportStyledSelector.prototype.setValue = function(value){
	if(this.placeholder){
		this.jqSelInput.val(this.placeholder);
	}else{
...
AssetImportStyledSelector.prototype.getLabel = function(){
	if(this.value !== undefined)
		return this.vlPairs[this.value];
};

AssetImportStyledSelector.prototype.disable = function(){
	this.jqSelInput.attr('disabled', true);
	this.jqDropIcon.unbind();
};

AssetImportStyledSelector.prototype.enable = function(){
    var self = this;
...
AssetImportStyledSelector.prototype.showDropBox = function(){
	this.jqDropBox.show();
	this.droped = true;
	this.setDropIcon();
	this.expandCallback()
...
AssetImportStyledSelector.prototype.hideDropBox = function(){
	this.jqDropBox.hide();
	this.droped = false;
	this.setDropIcon();
...
AssetImportStyledSelector.prototype.setDropIcon = function(){
	var icon;
	if(this.droped){
...
AssetImportStyledSelector.prototype.updateOptions = function(options){
	this.selectables = options;
	this.init();
	this.create();
};

AssetImportStyledSelector.prototype.handleDropdowns = function(target, delegate){
    var container = document.getElementById(this.containerId);
...
AssetImportStyledSelector.entities = {
	'&gt;': '>',
	'&lt;': '<'
};
