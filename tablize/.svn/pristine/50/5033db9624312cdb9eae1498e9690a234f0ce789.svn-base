var operateDaySum = (function($){
  ...
  var daySum = {
    init: function(){
      var self = this;
      this.userChart = echarts.init(document.getElementById('operateDaySum_day-sum-pcount-chart'));
      // this.actionChart = echarts.init(document.getElementById('day-sum-tcount-chart'));
      this.scaleSelect = getSelector('operateDaySum_day-sum-scale-select',[{
    ...
    drawSummary: function(){
      this.getSummaryData(function(data){
        ...
        $('#operateDaySum_day-sum-totals').empty().append(frag);
...
//
    ...
    setUserChecker: function(){
      ...
      $('#operateDaySum_day-sum-pcount-indexes').on('click', function() {
    ...
    drawUserList: function(keys, data){
      ...
      $('#operateDaySum_day-sum-pcount-list').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
    ...
    setActionChecker: function(){
      ...
      $('#operateDaySum_day-sum-tcount-indexes').on('click', function(){
    ...
    drawActionList: function(keys, data){
      ...
      $('#operateDaySum_day-sum-tcount-list').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
