var OATrendHour = (function($){
  ...
  var iTrend = {
    init: function(){
      var self = this;
      this.userChart = echarts.init(document.getElementById('oaTrendHour-sum-pcount-chart'));
      // this.actionChart = echarts.init(document.getElementById('oaTrendHour-sum-tcount-chart'));
      this.scaleSelect = getSelector('oaTrendHour-sum-scale-select',[{
      ...
      this.datePicker = new DatePicker({
        containerId: 'oa-oaTrendHour-start-datepicker',
    ...
    getQueryTimeStr: function(){
      var dateStr = this.datePicker.getDateStr();
    ...
    setUserChecker: function(){
      ...
      $('#oaTrendHour-sum-pcount-indexes').on('click', function() {
    ...
    drawUserList: function(keys, data){
      ...
      $('#oaTrendHour-sum-pcount-list').mCustomScrollbar('destroy').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
    ...
    setActionChecker: function(){
      ...
      $('#oaTrendHour-sum-tcount-indexes').on('click', function(){
    ...
    drawActionList: function(keys, data){
     ...
     $('#oaTrendHour-sum-tcount-list').mCustomScrollbar('destroy').empty().append($list).mCustomScrollbar({
        axis: 'yx'
      });
    },
