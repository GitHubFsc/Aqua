...
DatesGrid.prototype.drawGrid = function(){
    ...
    for(var i = 0; i < this.helper.date_list.length; i++){
        ...
        var data_single = format_.call(this.helper.date_list[i], "yyyy-MM-dd");
 ...
 * Calendar构建
 */
function Calendar(containerId, custom, year, month){
    this.html = "";
    this.containerId = containerId;
...
Calendar.prototype.onClick = function(object){
    switch(object.id){
        case "back-year":
            this.monthChange(-2);
            break;
 ...
 */
Calendar.prototype.extendOnClick = function(object){
};
...
Calendar.prototype.refreshCurrMonthElements = function(){
    this.curr_month_date_elements = [];
 ...
 */
Calendar.prototype.extendRefresh = function(date_list){
};

Calendar.prototype.eventHndl = function(){
