...
(function(q) {
    ...
    i = {
        ...
        makeDOMNodeLine: function(a, b, c) {
						var display_=((c.tId.substring(c.tId.length-11,c.tId.length))=="menu-tree_1"?"none":"block");
            a.push("<div style=\"position:absolute;width:100%;height:13px;background-color:white\"></div><img style=\"position:absolute;;display:"+display_+";top:20px;left:-20px\" src=\"content/xi_tong_yong_hu_guan_li/images/line.png\"/><span id='", c.tId, f.id.SWITCH, "' title='' class='", i.makeNodeLineClass(b, c), "' treeNode", f.id.SWITCH, "></span>")
				},
