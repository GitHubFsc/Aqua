...
StyledList.prototype.init = function(){
	this.footLabels = {
		navPre: i18n('UIWIDGET_STYLEDLIST_ZHUANDAODI'),
		navSuf: i18n('UIWIDGET_STYLEDLIST_YE_COMMA'),
		curPre: i18n('UIWIDGET_STYLEDLIST_DANGQIANDI'),
		curSuf: i18n('UIWIDGET_STYLEDLIST_YE_COMMA'),
		totPre: i18n('UIWIDGET_STYLEDLIST_GONG'),
		totSuf: i18n('UIWIDGET_STYLEDLIST_YE')
	};
	this.currPage = 0;
