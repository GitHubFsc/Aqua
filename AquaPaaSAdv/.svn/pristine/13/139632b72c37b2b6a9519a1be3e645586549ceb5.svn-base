...
(function () {
  ...
  newSelect.prototype.createSelect = function () {
    ...
    this.headerOpenIcon = jQuery("<img style='display:block'/>");
    this.headerOpenIcon.appendTo(this.headerIcon);
    this.headerCloseIcon = jQuery("<img style='display:block'/>");
  ...
  newSelect.prototype.setStyle = function () {
    ...
    if (this.selectstyle.width && this.selectstyle.height) {
      ...
      var height_ = this.selectstyle.height;
			var iconWidth=this.selectstyle.iconWidth||20;
      ...
      this.headerIcon.css({width: iconWidth+"px", height: height_ - 2, "line-height": (height_ - 2) + "px"});
  ...
  newSelect.prototype.listenClick = function () {
    ...
    that.content.find("li").on("click", function () {
      ...
      that.listenLiClick(jQuery(this).attr('data-key'));
		...
		that.content.find("li").css("background-color", that.selectstyle.selectLibackground);
    that.content.find("li").hover(function () {
      if (that.selectstyle.background && that.selectstyle.selectLibackground) {
        jQuery(this).css("background-color", that.selectstyle.selectLibackground);
      }
      else {
