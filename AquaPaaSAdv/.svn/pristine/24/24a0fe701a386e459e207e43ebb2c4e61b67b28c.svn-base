...
StyledListClone.prototype.init = function(){
	this.footLabels = {
...
StyledListClone.prototype.create = function(){
	this.createList();
	var self = this;
...
StyledListClone.prototype.getPageData = function(pageNumber, callback){

};

StyledListClone.prototype.onTotalCount = function(count){
    this.totalCount = Number(count);
    this.pagesLmt = Math.ceil(this.totalCount/this.rowsLmt);
};

StyledListClone.prototype.update = function(param){
	if(this.listType === 0){
		this.data = param;
		this.totalCount = this.data && this.data.length  || 0;
		this.pagesLmt = Math.ceil(this.totalCount/this.rowsLmt);
...
StyledListClone.prototype.fillContent = function(callback){
...
StyledListClone.prototype.createList = function(){
...
StyledListClone.prototype.fillList = function(){
	this.fillListHead();
	this.fillListBody();
	this.fillListFoot();
};

StyledListClone.prototype.addListHead = function(jqTable){
...
StyledListClone.prototype.fillListHead = function(){
	var self = this;
...
StyledListClone.prototype.addListBody = function(jqTable){
...
StyledListClone.prototype.fillListBody = function(){
	var self = this;
...
StyledListClone.prototype.addListFoot = function(jqTable){
...
StyledListClone.prototype.fillListFoot = function(){
	var self = this;
...
StyledListClone.prototype.getPrevIcon = function(){
...
StyledListClone.prototype.getNextIcon = function(){
	var iconColor = this.styles && this.styles.iconColor || 'black';
...
StyledListClone.prototype.setStyles = function(jqTable){
...
StyledListClone.prototype.changePage = function(changeType){
...
StyledListClone.prototype.refreshList = function(){
	var self = this;
	this.fillContent(function(){
		if(self.updateTitle){
			self.fillListHead();
...
StyledListClone.prototype.updateInPage = function(data){
	//Same length of Data
	if(this.listType === 0){
		this.data = data;
		this.fillContent();
...
StyledListClone.prototype.resize = function(){
    this.createList();
    this.fillList();
};
