//调用实例参数如下
/*
 this.searchSelect = new newSelectChooseSelfAdvUser("#exer-list-page-search-select", [{
 key: "exercise_id",
...
(function () {
  ...
  function newSelectChooseSelfAdvUser(cantainID, obj, style, listenLiClick, isOther) {
    /*
     style{
     width,
     height,
  ...
  newSelectChooseSelfAdvUser.prototype.init = function () {
    this.createSelect();
    this.setStyle();
    this.listenClick();
  }
  newSelectChooseSelfAdvUser.prototype.createSelect = function () {
  ...
  newSelectChooseSelfAdvUser.prototype.setStyle = function () {
    var that = this;
    this.box.css({
      "position": "relative",
      "box-sizing": "border-box"
  ...
  newSelectChooseSelfAdvUser.prototype.listenClick = function () {
    var that = this;
  ...
  newSelectChooseSelfAdvUser.prototype.getValue = function () {
    return this.header.attr('data-key');
  }
  newSelectChooseSelfAdvUser.prototype.getKey = function () {
    return this.headerContent[0].innerHTML;
  }
  newSelectChooseSelfAdvUser.prototype.setValue = function (value) {
    var that = this;
  ...
  newSelectChooseSelfAdvUser.prototype.setKey = function (key) {
    var that = this;
    var data = this.selectItem;
    var i;
    var boolean_found = false;
  ...
  newSelectChooseSelfAdvUser.prototype.setDisable = function () {
  ...
  newSelectChooseSelfAdvUser.prototype.setAvailable = function () {
    this.booleanAvailable = true;
    this.header.css({"background-color": this.selectstyle.background});
  }
  newSelectChooseSelfAdvUser.prototype.updateSelectOptions = function (obj) {
    this.destory();
    this.selectItem = obj;
    this.init();
  }
  newSelectChooseSelfAdvUser.prototype.switchToOpenIcon = function () {
    this.headerOpenIcon.css({"display": "block"});
    this.headerCloseIcon.hide();
    this.content.hide();
  }
  newSelectChooseSelfAdvUser.prototype.switchToCloseIcon = function () {
    this.headerOpenIcon.hide();
    this.headerCloseIcon.css({"display": "block"});
    this.content.show();
  }
  newSelectChooseSelfAdvUser.prototype.destory = function (obj) {
  ...
  window.newSelectChooseSelfAdvUser = newSelectChooseSelfAdvUser;
})();
