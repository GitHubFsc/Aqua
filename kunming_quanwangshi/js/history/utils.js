(function(global, factory) {
    ...
    //获得数据
    function getJson(type, src, Accept, callback) {
        doRequest({
            type: type,
            url: src,
            Accept: Accept,
    ...
    function doRequest(opts) {
        ...
        request.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                callback && callback(JSON.parse(this.response || '{}'), 'success');
    ...
    function debug(enable) {
        ...
        if (!logPane) {
            ...
            logPane.style.backgroundColor = '#000';
    ...
    function exitApp() {
        ...
        if (navigator.userAgent.lastIndexOf('iPanel') > -1) { //linux
            ...
            //     backUrl = portal
            // }
           window.location.href = "app://exit"  //location.href = backUrl
        }
    }
    /**
     * 保存应用入口portal
