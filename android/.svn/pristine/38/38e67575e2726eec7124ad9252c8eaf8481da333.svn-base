...
var treeRoot = paas_host + '/aquapaas/rest/navigation/trees/年华/法律热线';
// var treeRoot = paas_host + '/aquapaas/rest/navigation/trees/年华/律师热线';
var app_key = 'aquaBO';//树结构的app_key
var paasAppSecret = '5b161e40e4e31db5307d7e520814e11f7d9e600f8e8e9ee06f22faed5afb';
// //本地测试使用
// var paas_host = 'http://192.168.7.143:8080'
// var treeRoot = paas_host + '/aquapaas/rest/navigation/trees/nianhua/律师热线/';
// var app_key = 'aquaBO'; //树结构的app_key
...
var DeviceType = 3; // 1: 安卓浪潮机顶盒 2:安卓九州机顶盒 3:Linux(2200)机顶盒 已废弃
//Linux机顶盒VSP播放路径
